...
但我们还是能学从前Stanford现在Columbia的Tim Roughgarden教授他在YouTube和Coursera上公开算法课的那句名言：
![Can we do better?](algo_mindset.jpg)

[Roughgarden教授头是真光 但也超会教的](https://www.youtube.com/watch?v=yRM3sc57q0c&list=PLEAYkSg4uSQ37A6_NrUnTHEKp6EkAxTMa)


### 我如何看待"Second" Next Greater这句描述
各位不妨先想想看一个底层问题：什么样的元素 __才值得 或者说 才有资格__ 去讨论『我的Second Next Greater在哪儿🥲』？
...
第一点既然已知能靠Monotonic Decreasing Stack解决 那第二点显然也能呀 开一号栈给第一点 二号栈给第二点

我们往后只要在遍历$nums$的过程中 请当前被轮值道的元素$y$先来检查二号栈
...
2. 乘上题 最差情况下的时间复杂度 和$k$有关系吗？若沒有关系 那又是为什么呢？此刻时间复杂度又是多少😏
