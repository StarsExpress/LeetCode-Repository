...
class MaxHeap:
    ...
    def find_max_value(self, remove=False):
        if remove:
    ...
    def find_median_value(self):
        ...
        # Median is defined by rank from smallest to largest. In max heap, depth needs to add 1 if items count is even.
        median_depth = (total_items + 1) // 2 if total_items % 2 == 1 else 1 + total_items // 2
